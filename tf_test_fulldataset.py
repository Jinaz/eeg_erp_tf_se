...
def plotit(T_obs,clusters,cluster_p_values,times,freqs,ch_name,evoked_condition_1,evoked_condition_2):
    plt.figure()
    ...
    plt.savefig("img/TF_permutationCluster.png")
...
if __name__ =="__main__":
    ...
    for sid in ids:
        ...
        facetfrs.append(epochs_condition_1)
        cartfrs.append(epochs_condition_2)

        faceconds.append(evoked_condition_1)
        carconds.append(evoked_condition_2)

    tfr_epochs_1 = tfr_morlet(facetfrs, freqs,
                                n_cycles=n_cycles, decim=decim,
                                return_itc=False, average=False)

    tfr_epochs_2 = tfr_morlet(cartfrs, freqs,
                                n_cycles=n_cycles, decim=decim,
                                return_itc=False, average=False)
    ...
    evoked_condition_1 = mne.grand_average(faceconds)
    evoked_condition_2 = mne.grand_average(carconds)
    ...
    plotit(T_obs,clusters,cluster_p_values,times,freqs,ch_name,evoked_condition_1,evoked_condition_2)
